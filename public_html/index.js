...
const settingModalString = ` <section id="setting-page"
            class="bg-white/10 w-full h-full flex flex-col items-center justify-center absolute z-30 backdrop-blur-lg setting-fade rounded-xl text-tenpercent gap-y-5 tracking-wide text-lg"
          >
            <div
